"""A3 -- hypothesis generation. Prompt version 5.
...
alongside the existing claims/hypotheses. Nothing else about A3's task
changes.
...
least 2 of which must be benign explanations, plus this call's
self-reported trust triad.
"""
...
PROMPT_VERSION = "a3_hypotheses_v5"

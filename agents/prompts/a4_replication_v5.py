"""A4 -- blind replication. Prompt version 5.

Changes from v4: adds the self-reported trust triad (confidence,
evidence_support, verification -- agents/prompts/render.py::
SELF_REPORT_INSTRUCTIONS, agents/schema.py::HypothesisResponse)
alongside the existing claims/hypotheses. Nothing else about A4's task
changes -- still a blind, single-pass replica with no visibility into
the chain.
...
output, plus this call's self-reported trust triad.
"""
...
PROMPT_VERSION = "a4_replication_v5"
